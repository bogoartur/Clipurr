...
final class StatusBarController {
    ...
    func showPopover() {
        ...
        // Clipurr as frontmost and have nowhere to paste into.
    ...
    private func configureStatusItem() {
        if let button = statusItem.button {
            let image = NSImage(systemSymbolName: "doc.on.clipboard", accessibilityDescription: "Clipurr Clipboard Manager")
